...
\newcommand{\twoheadmapsto}{\mapsto\!\!\!\!\to}
...
\newcommand{\pleft}[1][p]{\overset{\leftarrow}{#1}}
\newcommand{\pright}[1][p]{\overset{\rightarrow}{#1}}
...
\newcommand{\TVd}{\ensuremath{\mathsf{TV}}\xspace}
